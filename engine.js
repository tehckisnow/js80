...
//---------------------
//create an html doc and set a script src to this file as well
//as a file that contains the functions: "init()" and "frame()". (optionally: preload() and settings())

//this file does the following:
// 1. sets up the game
// 2. calls init()
// 3. calls frame() 50 times per second
...
//settings.settings() method (do I actually need this?)
//reset()
//mouse()
//click()
//btnp();

//consider creating map constructor object that holds the tilesize.  both map() and mget() would benefit from this
...
//render function draws whatever sprite an entity should have currently (part of ECS)
//animation (part of ECS?)
//default collision detection system (part of ECS?)
//finish ECS system
//scenes manager
//test like crazy!
